...
if __name__=="__main__":
  ...
  #cyear = int(sys.argv[4])
 
  pco2 = getndco2(sys.argv[3])[1]
  pco2_old = pco2
  
  p0 = 1010670.0
  psurf = p0 + pco2
  
  cyear = len(glob.glob("*_MOST.*.nc"))
  ...
  trelaxed = False
  longtime=False
  while ntgl < ntgl+100 and not glacrelaxed and not trelaxed and cyear<cmaxyears: #No more than 50 iterations
