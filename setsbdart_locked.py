...
def prep(job):
  ...
  os.system("cp sbdart_locked/buildsbdart.py "+workdir+"/")
  os.system("cp crawldefs.py "+workdir+"/")
  os.system("cp identity.py "+workdir+"/")
  os.system("cp crawldefs.py sbdart_locked/")
  os.system("cp batch_system.py "+workdir+"/")
  os.system("cp batch_system.py sbdart_locked/")
  os.system("cp torque.py "+workdir+"/")
  os.system("cp slurm.py "+workdir+"/")
  os.system("cp torque.py sbdart_locked/")
  ...
  rs = open(workdir+"/runsbdart_locked","w")
  rs.write(jobscript)
  rs.close()
          
 
def submit(job):
  workdir = "sbdart_locked/job"+str(job.home)
